...
const userSockets = {}; // Map userId to socket connections
...
io.on('connection', (socket) => {
  ...
  socket.on('join_conversation', (data) => {
    ...
    console.log(`User ${data.username} joined conversation ${data.conversationId}`);
  });

  socket.on('leave_conversation', (data) => {
    socket.leave(data.conversationId);
    console.log(`User ${data.username} left conversation ${data.conversationId}`);
  });
